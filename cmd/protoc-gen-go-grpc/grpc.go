...
const (
	...
	grpcPackage    = protogen.GoImportPath("github.com/qiaohao9/grpc")
	codesPackage   = protogen.GoImportPath("github.com/qiaohao9/grpc/codes")
	statusPackage  = protogen.GoImportPath("github.com/qiaohao9/grpc/status")
)
...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P("//")
	g.P("// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/github.com/qiaohao9/grpc/?tab=doc#ClientConn.NewStream.")
