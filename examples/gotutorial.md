...
```shell
$ go get github.com/qiaohao9/grpc
```

Then change your current directory to `grpc-go/examples/route_guide`:
```shell
$ cd $GOPATH/src/github.com/qiaohao9/grpc/examples/route_guide
```
...
`$GOPATH/src/github.com/qiaohao9/grpc/examples/route_guide`, simply:
